...
WORKDIR /src
COPY ["src/Services/UserServiceApi/UserServiceApi.csproj", "src/Services/UserServiceApi/"]
RUN dotnet restore "./src/Services/UserServiceApi/UserServiceApi.csproj"
COPY . .
WORKDIR "/src/src/Services/UserServiceApi"
